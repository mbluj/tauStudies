...
def addArguments(parser):
    parser.add_argument('-i', '--inputfiles', nargs='*', help='List of files')
    ...
    parser.add_argument('-m', '--mvaid', default=[], nargs='*', help='Select mvaIDs that should be obtained via rerunning TAUId sequence, e.g. [2017v1, 2017v2, newDM2017v2, dR0p32017v2, 2016v1, newDM2016v1] [Default: %(default)s]')
    parser.add_argument('-t', '--tauCollection', default='slimmedTaus', help='Tau collection to be used [Default: %(default)s]')
    parser.add_argument('--addAntiLepton', default=False, action='store_true', help='Access classic anti-lepton discriminators (can be not present in recent samples) [Default: %(default)s]')
    parser.add_argument('--addMVAIso', default=False, action='store_true', help='Access MVAIso discriminators (can be not present in recent samples) [Default: %(default)s]')
    ...
    parser.add_argument('--debug', default=False, action='store_true', help='Debug option [Default: %(default)s]')
